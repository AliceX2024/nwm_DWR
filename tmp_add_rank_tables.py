...
metrics = ['lpips', 'psnr']
metric_display = {'lpips': 'LPIPS', 'psnr': 'PSNR'}
...
blocks = []
blocks.append('## 四个数据集的 LPIPS / PSNR 排名汇总表')
blocks.append('')
blocks.append('- 排名规则：LPIPS 越低 rank 越高；PSNR 越高 rank 越高；`rank 1` 表示该时间点该指标下三种方法中的最佳。')
blocks.append('')
